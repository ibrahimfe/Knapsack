...
class TestKnapsackGreedy(unittest.TestCase):
    ...
    def test_two_items(self):
        ...
        self.assertEqual(knapsack_recursive_memoization([1, 2], [1, 2], 10), 3, "Expected 3")
    ...
    def test_three_items(self):
        ...
        self.assertEqual(knapsack_recursive_memoization([1, 2, 3], [1, 2, 3], 10), 6, "Expected 6")

    def test_four_items(self):
        self.assertEqual(knapsack_greedy([1, 2, 3, 4], [1, 2, 3, 4], 10), 10, "Expected 10")
        self.assertEqual(dynamic_knapsack([1, 2, 3, 4], [1, 2, 3, 4], 10), 10, "Expected 10")
        self.assertEqual(knapsack_recursive_memoization([1, 2, 3, 4], [1, 2, 3, 4], 10), 10, "Expected 10")

    def test_capacity_exceeded(self):
        self.assertEqual(knapsack_greedy([1, 2, 3, 4], [1, 2, 3, 4], 5), 3, "Expected 3")
        self.assertEqual(dynamic_knapsack([1, 2, 3, 4], [1, 2, 3, 4], 5), 5, "Expected 5")
        self.assertEqual(knapsack_recursive_memoization([1, 2, 3, 4], [1, 2, 3, 4], 5), 5, "Expected 5")
    ...
    def test_random_inputs(self):
        ...
        actual_result_recurive = knapsack_recursive_memoization(weights, values, capacity)
